  ...
  return (
    <div className="min-h-screen bg-instinct-white">
      ...
      <main className="pt-20 pb-16 px-6">
        {/* Hero Section */}
        <section className="py-20 bg-instinct-black text-instinct-white -mx-6">
          <div className="max-w-4xl mx-auto text-center px-6">
            <h1 className="text-3xl font-normal mb-6">
              Крупнейшие мероприятия СНГ
            </h1>
            <p className="text-lg text-instinct-white/70 max-w-2xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 mb-20 -mt-10">
            <div className="aspect-video bg-instinct-white/10 rounded-lg flex items-center justify-center border border-instinct-black/10 bg-instinct-black/5">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-instinct-black mb-4">Кинопремьеры</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-instinct-black mb-4">Награждения</h3>
                  <p className="text-sm text-instinct-black/60 leading-relaxed">
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-instinct-black mb-4">Фестивали</h3>
                  <p className="text-sm text-instinct-black/60 leading-relaxed">
