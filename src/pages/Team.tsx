...
const Team = () => {
  ...
  const team = [
    ...
    {
      name: "Всеволод Котович",
      role: "Продюсер",
      experience: "12 лет в индустрии",
      description: "Эксперт в управлении крупными проектами"
    },
    {
      name: "Косов Павел",
      role: "Креативный продюсер",
      experience: "10 лет в креативе",
      description: "Отвечает за творческую составляющую проектов"
    },
    {
      name: "Грибков Сергей",
      role: "Продюсер производства",
      experience: "14 лет в продакшне",
      description: "Координирует все этапы производства"
    },
    {
      name: "Будников Егор",
      role: "CTO",
      experience: "8 лет в технологиях",
      description: "Руководит технической стороной проектов"
    },
    {
      name: "Валентин Булгаков",
      role: "Арт-директор",
      experience: "11 лет в дизайне",
      description: "Создаёт визуальную концепцию проектов"
    },
    {
      name: "Шуляк Стася",
      role: "Менеджер проектов",
      experience: "7 лет в управлении",
      description: "Координирует работу команды и сроки"
    },
    {
      name: "Шкредова Юлия",
      role: "Менеджер по работе с клиентами",
      experience: "9 лет в клиентском сервисе",
      description: "Обеспечивает коммуникацию с заказчиками"
    },
    {
      name: "Гилева Анастасия",
      role: "Аккаунт менеджер",
      experience: "6 лет в продажах",
      description: "Ведёт клиентские проекты от старта до финиша"
    },
    {
      name: "Бораборкин Александр",
      role: "Технический специалист",
      experience: "5 лет в IT",
      description: "Обеспечивает техническую поддержку съёмок"
    }
  ];
